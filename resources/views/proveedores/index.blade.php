        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editProveedorForm">
                    ...
                    <div class="mb-3">
                        <label for="edit_contacto" class="form-label">
                    ...
                    <div class="mb-3">
                        <label for="edit_cuit" class="form-label">
                            <i class="fa-solid fa-id-card"></i> CUIT
                        </label>
                        <input type="cuit" class="form-control" id="edit_cuit" name="cuit">
                    </div>

                    <label id="edit_cat_prov" class="form-label" style="margin-bottom:20px;">Categorías</label>
                    <div id="categorias-container"  style="overflow-y: auto; max-height: 250px; border-radius: 0.25rem; background: #acd8b5; padding: 10px;">
