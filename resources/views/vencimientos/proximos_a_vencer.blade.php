                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        @foreach ($lotesProximosAVencer as $lote)
                            <tr>
                                <td data-label="Código">{{ $lote->producto->codigo }}</td>
                                <td data-label="Nombre">{{ $lote->producto->nombre }}</td>
                                <td data-label="Fecha de Vencimiento">{{ $lote->fecha_vencimiento }}</td>
                                <td data-label="Número de lote">{{ $lote->numero_lote }}</td>
